...
{
    class AFElementLoader : LazyObjects.IAFElement
    {
        ...
        private BaseObject BuildObject()
        {
            Random ran = new Random();
            int num = ran.Next(100);
            return new BaseObject("034210534215", "Element" + num.ToString(), "Description for testing", "\\\\AFDB\\Element " + num.ToString());
        }
    }
}

...
namespace LazyPI.LazyObjects
{
    public interface IAFElement
    {
        ...
        IEnumerable<AFElement> GetEventFrames(Connection Connection, string ElementID, SearchMode SearchMode, DateTime StartTime, DateTime EndTime, string NameFilter, string CategoryName, string TemplateName, string SortField, string SortOrder, int StartIndex, int MaxCount);
    }
}
